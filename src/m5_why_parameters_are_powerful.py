...
def main():
    ...
    even_better_draw_circles(rg.Point(-100, 12), 'red', 2, 5)
    even_better_draw_circles(rg.Point(100, -12), 'green', 2, 6)
    even_better_draw_circles(rg.Point(100, 24), 'red', 2, 5)
    even_better_draw_circles(rg.Point(-100, -24), 'green', 2, 5)

    #better_draw_circles(rg.Point(0,0))
    #better_draw_circles(rg.Point(150,-100))
...
def better_draw_circles(point):
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(5 * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point, color, thickness, radii):
